...
<head>
    ...
    <title>Maintenance Assignment</title>
    <style>
...
<body style="margin:0; padding:0; background-color:#f4f7fb; font-family:Arial, Helvetica, sans-serif;">
    ...
    <div style="display: none; font-size: 0; color: #f4f7fb; max-height: 0px; overflow: hidden;">
        New maintenance task assigned: {{ $job->title }} - View details in MGM Ops.
    </div>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 35px 30px;">
                            ...
                            <p style="margin: 0 0 30px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                A new maintenance task has been assigned to you. Please review the details below and take necessary action.
                            </p>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                        <tr>
                                                            ...
                                                            <td class="mobile-full-width" width="50%" style="padding-bottom: 20px; vertical-align: top;">
                                                                ...
                                                                <span style="display: inline-block; padding: 6px 12px; border-radius: 20px; background-color: #eff6ff; color: #1d4ed8; font-size: 13px; font-weight: 700;">
                                                                    {{ ucfirst($job->status) }}
                                                                </span>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td align="center" style="border-radius: 10px; background: linear-gradient(135deg, #1583ff, #2d5bff); box-shadow: 0 4px 12px rgba(21, 131, 255, 0.3);">
                                                    <a href="{{ url('/admin/maintenance') }}" target="_blank" style="font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 10px; display: inline-block;">
                                                        View Job Details
                                                    </a>
                                                </td>
                                            </tr>
