...
<div class="breadcrumb">
    ...
    <span class="separator">/</span>
    <span class="current">Weekly Rota View</span>
</div>
...
<div class="rota-board-card">
    ...
    <div class="board-header">
        ...
        <div class="actions">
            <!-- Week Navigation -->
            <div class="week-nav">
                <a href="{{ route('manager.rota.view', ['week_start' => $weekStart->copy()->subWeek()->format('Y-m-d')]) }}" 
                   class="nav-btn" title="Previous Week">
                    <i class="fas fa-chevron-left"></i>
                </a>
                
                <a href="{{ route('manager.rota.view', ['week_start' => now()->startOfWeek()->format('Y-m-d')]) }}" 
                   class="nav-btn today">
                    Today
                </a>
                
                <a href="{{ route('manager.rota.view', ['week_start' => $weekStart->copy()->addWeek()->format('Y-m-d')]) }}" 
            ...
            <a href="{{ route('manager.rota.pdf', ['week_start' => $weekStart->format('Y-m-d')]) }}" class="pdf-btn">
                <i class="fas fa-file-pdf"></i> PDF
            </a>
            
            {{-- <a href="{{ route('manager.rota.excel', ['week_start' => $weekStart->format('Y-m-d')]) }}" class="excel-btn">
    ...
    <div class="legend-bar">
        <span class="legend-title"><i class="fas fa-info-circle"></i> Legend:</span>
    ...
    @foreach($departments as $department)
        ...
        <div class="department-section">
            ...
            <div class="department-title">
                ...
                <span class="emp-count">{{ $department->users->count() }} employees</span>
            </div>
                            ...
                            <tr>
                                <td class="employee-name">
                                    <div class="emp-info">
                                        ...
                                        <small>{{ $employee->role->name ?? 'Staff' }}</small>
                                    </div>
                                </td>
